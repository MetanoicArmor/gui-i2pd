...
[![Download](https://img.shields.io/badge/📥%20Скачать-I2P%20Daemon%20GUI.app-brightgreen.svg)](https://github.com/MetanoicArmor/gui-i2pd/releases/download/v2.59.0/I2P-Daemon-GUI-2.59.0.zip)
...
- 💬 **Встроенный чат I2P** - P2P чат в отдельном окне (termchat-i2p)
...
<img src="screenshots/screenshot5_ru.png" alt="I2P GUI Модуль Утилит" width="260">

*Встроенный модуль Утилит с комплексным набором I2P утилит*

![I2P GUI Генерация ключей](screenshots/screenshot6_ru.png)
*Утилита генерации ключей с выбором типа подписи*

![I2P GUI Майнинг адресов](screenshots/screenshot7_ru.png)
*Утилита майнинга адресов для vanity адресов*

![I2P GUI Регистрация доменов](screenshots/screenshot8_ru.png)
*Утилита регистрации доменов для доменов .i2p*

![I2P GUI Интерактивный терминал](screenshots/screenshot9_ru.png)
...
<img src="screenshots/screenshot11_en.png" alt="I2P GUI Chat — setup" width="800">

*Окно чата I2P — ввод ключей*

<img src="screenshots/screenshot12_en.png" alt="I2P GUI Chat — conversation" width="800">
...
- **Исходный проект:** [termchat-i2p](http://git.community.i2p/stan/termchat-i2p) (автор stan, git сообщества I2P)
- **Описание:** Децентрализованный чат поверх I2P: без центрального сервера, обмен сообщениями по туннелям I2P. GUI запускает бинарник termchat-i2p в терминальном виде, так что чатом можно пользоваться, не выходя из приложения.
...
- **💬 Чат** - окно P2P чата I2P (termchat-i2p)
...
- **Daemon**: i2pd 2.59.0 (встроенный бинарник)
...
I2P Daemon GUI.app/
├── Contents/
│   ├── Info.plist              # Метаданные (версия 2.59.0)
│   ├── MacOS/
...
### 🏆 **v2.59.0 (Current)** - Стабильная версия с полным функционалом и интернационализацией
- ✅ Полная интернационализация (Русский/English) с умным перезапуском
...
Info.plist              # Метаданные приложения (версия 2.59.0)
```
...
### 🚀 Прямое скачивание:
[![Download I2P Daemon GUI.app](https://img.shields.io/badge/📦%20Скачать-I2P%20Daemon%20GUI.app-ff6b6b.svg?style=for-the-badge)](https://github.com/MetanoicArmor/gui-i2pd/releases/download/v2.59.0/I2P-Daemon-GUI-2.59.0.zip)
