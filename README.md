...
- ⚙️ **Гибкие настройки** конфигурации
...
![I2P GUI Screenshot](screenshot.png)

*Внешний вид основного интерфейса приложения*
...
- **📊 Мониторинг**: частота обновления статуса
- **🔔 Уведомления**: настройки уведомлений системы
- **🌐 Веб-консоль**: переход к веб-интерфейсу I2P
...
- **i2pd daemon**: официальная реализация протокола I2P
